<template>
  <Head>
    <title>Visualizacão de Transações</title>
  </Head>
  <div>
        ...
        <li>
          ...
          <div class="px-4 py-4 sm:px-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex flex-shrink-0 ml-2">
                <p class="inline-flex px-2 text-xs font-semibold leading-5 rounded-full">
                  {{convertFloatMoney(conta.saldo_inicial)}}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="px-4 py-4 sm:px-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex flex-shrink-0 ml-2">
                <p class="inline-flex px-2 text-xs font-semibold leading-5 rounded-full">
                  {{convertFloatMoney(conta.saldo_atual)}}
                </p>
              </div>
            </div>
          </div>
           ...
           <div class="px-4 py-4 sm:px-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex flex-shrink-0 ml-2">
                <p class="inline-flex px-2 text-xs font-semibold leading-5 rounded-full">
                  {{convertData(conta.data_abertura)}}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="px-4 py-4 sm:px-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex flex-shrink-0 ml-2">
                <p class="inline-flex px-2 text-xs font-semibold leading-5 rounded-full">
                  <span v-if="conta.status == 1">Ativa</span>
                  <span v-else>Desativada</span>
                </p>
              </div>
            </div>
          </div>
  ...
  <hr>
  <div class="px-0 py-3 mx-0 text-left sm:px-6">
  ...
  setup() {
    return {
      links:[
        ...
        { name: 'Visualizacão de Conta Digital', current: true },
      ]
    }
  },
   props: {
