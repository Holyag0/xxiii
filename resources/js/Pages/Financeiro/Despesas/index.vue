...
<template>
  ...
  <div class="flex flex-col">
    ...
    <title-and-button-cad v-if="getPermission('despesa-create')" :link="'despesas.create'" :title="'Listagem Despesas'" />
        ...
        <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
          ...
          <div class="grid grid-cols-6 gap-6">
            ...
            <div class="flex text-sm font-medium text-right-inline">
              ...
              <Link :href="route('despesas.index')" class="block px-2 mt-1 text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm cd hover:bg-gray-50"><span class="sr-only">Filtrar</span><svg xmlns="http://www.w3.org/2000/svg" class="h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2M3 12l6.414 6.414a2 2 0 001.414.586H19a2 2 0 002-2V7a2 2 0 00-2-2h-8.172a2 2 0 00-1.414.586L3 12z" /></svg></Link>
          <div class="px-3">
             <a :href="route('gerar_relatorio.despesa')" @click="open = true" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-black bg-gray-300 border border-transparent rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              ...
              <div class="px-3">
                <a :href="route('depesas.vencimento')"  class="inline-flex items-center px-4 py-2 text-sm font-medium leading-4 text-black bg-red-300 border border-transparent rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" /><path d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z" /> </svg>
                   Despesas em Vencimento
                <p class="sr-only"></p>
              </a>
            </div>
              </div>
              ...
              <tr v-for="despesa in despesas.data" :key="despesa.id">
               ...
               <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                ...
                <td class="flex px-6 py-4 text-sm font-medium text-right-inline">
                  <Link v-if="despesa.status == 1 && getPermission('despesa-reabrir')" :href="route('despesas.reabrir', despesa.id)" class="text-sm text-blue-600 hover:text-blue-400">
                  ...
                  <Link v-if="despesa.status == 0 && getPermission('despesa-baixar')" :href="route('despesas.baixar', despesa.id)" class="text-sm text-blue-600 hover:text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                  </Link>
                  
                  <Link v-if="getPermission('despesa-show')" :href="route('despesas.show', despesa.id)" class="ml-2 mr-2 text-sm text-blue-600 hover:text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                  </Link>
                  
                  <Link :href="route('despesas.edit', despesa.id)" v-if="despesa.status != 1 && getPermission('despesa-edit')" class="text-sm text-blue-600 hover:text-blue-400">
                  ...
                  <a href="javascript:void(0);" v-if="despesa.status != 1 && getPermission('despesa-delete')" class="mr-2 text-sm text-blue-600 hover:text-blue-400" @click.prevent="deleteDespesa(despesa.id)">
