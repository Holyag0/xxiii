<template>
  <Head>
    <title>Baixa de Despesas</title>
  </Head>
  <div class="mt-10 sm:mt-0">
    <div class="flex-1 min-w-0 pb-4">
        <h1 class="text-lg font-medium leading-6 text-gray-900 sm:truncate">Baixar Despesas</h1>
    </div>
    
    <bread-crumbs class="mb-2" :pages="links" />
    <div class="md:grid md:grid-cols-2 md:gap-6">
      <div class="mt-5 md:mt-0 md:col-span-2">
        <form @submit.prevent='baixarDespesas' method="POST">
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-4 sm:col-span-3">
                  ...
                  <input disabled v-money="money" type="text" :value="convertFloatMoney(despesa.valor)" id="valor" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                </div>
  ...
  setup() {
    return {
      ...
      links:[
        ...
        { name: 'Baixar Despesas', current: true },
      ]
    }
  },
  methods:{
