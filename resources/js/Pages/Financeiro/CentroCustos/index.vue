...
<template>
  <Head>
    <title>Listagem de Centro de Custos</title>
  </Head>
  <div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">

    <title-and-button-cad :link="'centro_custos.create'" :title="'Listagem Centro de Custos'" />
        ...
        <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="custo in centroCustos.data" :key="custo.id">
               ...
               <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                ...
                <td class="flex px-6 py-4 text-sm font-medium text-right-inline">
                  <Link :href="route('centro_custos.show', custo.id)" class="mr-2 text-sm text-blue-600 hover:text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                  </Link>
                  
                  <Link :href="route('centro_custos.edit', custo.id)" class="text-sm text-blue-600 hover:text-blue-400">
  ...
  <Pagination :links="centroCustos.links" class="mt-6"/>
</template>
  ...
  setup() {
    return {
       links:[
        ...
        { name: 'Listagem de Centro de Custos', current: true },
      ]
    }
  },
  props: {
