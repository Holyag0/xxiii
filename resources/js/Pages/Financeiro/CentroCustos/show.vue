<template>
  <Head>
    <title>Visualização de Centro de Custos</title>
  </Head>
...
export default {
  ...
  setup() {
    return {
      links:[
        { name: 'Listagem de Centro de Custo', href: 'centro_custos.index', current: false },
        { name: 'Visualizacão de Centro de Custos', current: true },
      ]
    }
  },
   props: {
