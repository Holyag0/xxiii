<template>
  ...
  <div class="mt-10 sm:mt-0">
    <div class="flex-1 min-w-0 pb-4">
        <h1 class="text-lg font-medium leading-6 text-gray-900 sm:truncate">Edição de Categorias</h1>
    </div>
    
    <bread-crumbs class="mb-2" :pages="links" />
     <div class="md:grid md:grid-cols-2 md:gap-6">
      <div class="mt-5 md:mt-0 md:col-span-2">
        <form @submit.prevent='updateCategoria' method="POST">
...
let links = [
        { name: 'Listagem de Categorias', href: 'categorias.index', current: false },
        { name: 'Edição de Categorias', current: true },
      ]
